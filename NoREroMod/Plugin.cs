...
namespace NoREroMod
{
    ...
    public class Plugin : global::BepInEx.BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            global::NoREroMod.Plugin.eliteColor = base.Config.Bind<string>("Elites", "Color", "#ffffff", "Elites cab be tinted this color (#550055)");
            ...
            global::HarmonyLib.Harmony.CreateAndPatchAll(typeof(global::NoREroMod.SlavehelpPatch), null);
        }
